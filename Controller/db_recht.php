...
class DbRecht extends Database {
    ...
    public function getRecht(){
        $this->dbquery("SELECT * FROM recht WHERE 
                        recht_positie = '" . mysqli_real_escape_string($this->recht_positie) . "'");
    ...
    public function getRechtList($onderdeel = null){
        ...
        if($onderdeel == null){
            ...
            $this->dbquery("SELECT * FROM recht WHERE recht_onderdeel = '" . mysqli_real_escape_string($onderdeel) . "'");
        }
    ...
    public function saveRecht(){
        $this->dbquery("INSERT INTO recht (recht_onderdeel, recht_beschrijving) 
                        VALUES ('" . mysqli_real_escape_string($this->recht_onderdeel) . "',
                                '" . mysqli_real_escape_string($this->recht_beschrijving) . "')");
        
        $this->recht_positie = mysqli_insert_id();
    }
    
    public function updateRecht(){
        $this->dbquery("UPDATE recht SET recht_onderdeel = '" . mysqli_real_escape_string($this->recht_onderdeel) . "',
                                         recht_beschrijving = '" . mysqli_real_escape_string($this->recht_beschrijving) . "'
                        WHERE recht_positie ='" . mysqli_real_escape_string($this->recht_positie) . "'");
    }
    
    public function deleteRecht(){
        $this->dbquery("DELETE FROM recht WHERE recht_positie ='" . mysqli_real_escape_string($this->recht_positie) . "'");
    }
}
